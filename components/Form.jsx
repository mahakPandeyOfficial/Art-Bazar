  ...
  return (
    <div className="form">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <h3>You know about your Art! Let's tell People too....</h3>
        <div className="description">
          ...
          <span>₹</span>
          <input type="number" placeholder="Price" onChange={handleChange} name="price" value={work.price} required className="price" />
        </div>
